...
「いい体験」を定義し、それを再生産可能な仕組みとして設計するのが得意領域です。
...
- 英語
  - ビジネスレベル
    - 大学時代にUniversity of Californiaにてマーケティングを学ぶ
...
### 2020/09~現在: 株式会社Tokel
役職：代表取締役
職務：事業戦略立案、顧客体験デザイン、顧客行動デザイン、製品開発、販売戦略立案、オペレーション構築、SCM、会計、資金調達、人事戦略

### 2019/09-2020/09: Tokel Technology
役職：代表（個人事業主）
職務：事業戦略立案、顧客体験デザイン、顧客行動デザイン、製品開発、販売戦略立案、オペレーション構築

### 職務内容
- N社
  - 事業戦略立案、販売戦略立案、オペレーション構築
    - 新規会員獲得の仕組み化
    - 継続率を高めるためのデータ分析、及び顧客体験デザイン、顧客行動デザイン
- V社
  - 事業戦略立案、顧客体験デザイン、顧客行動デザイン、製品開発、販売戦略立案、オペレーション構築
    - MA導入・実装・組織への浸透
    - MAを用いた継続率改善、顧客満足度の向上を仕組み化
- O社
  - オペレーション構築
    - SFA, CRM, MAの選定・導入・実装・組織への浸透
    - 再生産性を高めるためのドキュメント化
    - SFA, CRMよりAPIを利用した営業データの集積・分析基盤構築
    - GASを用いた営業議事録の自動書き起こし
  - 顧客体験デザイン、顧客行動デザイン、事業戦略立案
    - リテンション率改善の分析・仕組み化
    - マッチング率改善の分析、仕組み化
    - セールスにおけるプロダクト改善点の分析
    - 開発/IS/FS/CSの連携
  - 営業戦略立案、実行
    ...
    - 顧客との折衝
    - 新メンバーのオンボーディング体制の構築
    - セールスイネーブルメントの設計、及び実行
    - 営業資料・手法・チャネルの改善



### 2015/07-2019/09：日本酒応援団株式会社
#### 2017/06-2019/09：
職務：共同創業者・事業責任者
